tell application "iTerm"
    ...
    tell current session of current window
        write text "cd /Users/shorovatin/Documents/MICAS/server/app/main/utils"
        delay 1
    ...
    tell current session of current window
        write text "cd /Users/shorovatin/Documents/MICAS"
        delay 1
            write text "conda activate micas"
        delay 1
    ...
    -- START UP FRONT END
    tell current session of current window
        write text "cd /Users/shorovatin/Documents/MICAS/frontend"
        delay 1

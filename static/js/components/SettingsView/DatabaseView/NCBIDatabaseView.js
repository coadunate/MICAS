...
class NCBIDatabaseView extends Component {
  constructor(props){
    super(props);
  ...
  render(){
    return(
      <div>
        <strong className="text-center" style={{marginLeft: 20 + 'px', textDecoration: 'underline'}}>NCBI Databases:</strong>
        <hr />
        <FormGroup>
          <Col md={12}>
            <Col md={4}>
...
export default NCBIDatabaseView;
